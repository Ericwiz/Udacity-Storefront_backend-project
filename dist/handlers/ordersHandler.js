...
exports.verificationToken = exports.addProduct = exports.currentOrderByUser = void 0;
var order_1 = require("../models/order");
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var dotenv_1 = __importDefault(require("dotenv"));
dotenv_1["default"].config;
var order = new order_1.ordersQueries();
var currentOrderByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user_id, myCurrentOrder, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user_id = req.body.user_id;
                return [4 /*yield*/, order.currentOrder(user_id)];
            case 1:
                myCurrentOrder = _a.sent();
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var quantity, orderId, productId, addedProduct, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
