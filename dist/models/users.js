...
var UsersStore = /** @class */ (function () {
    ...
    UsersStore.prototype.updateUser = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hash, result_2, result, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        sql = 'UPDATE users SET (firstname, lastname, password) = ($1, $2, $3) WHERE id = ($4) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        if (env === "dev") {
                            hash = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                            result_2 = conn.query(sql, [u.firstname, u.lastname, hash, u.id]);
                            conn.release();
                            return [2 /*return*/, result_2.rows[0]];
                        }
                        result = conn.query(sql, [u.firstname, u.lastname, u.password, u.id]);
                        conn.release();
                        return [2 /*return*/, result.rows[0]];
                    case 2:
                        error_4 = _a.sent();
                        throw new Error("Could not update user with id ".concat(u.id, ": ").concat(error_4));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Could not add product ".concat(productId, " to order r: ").concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
